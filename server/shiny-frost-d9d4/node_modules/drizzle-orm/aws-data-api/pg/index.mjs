...
import { ao as mapResultRow, a9 as fillPlaceholders, a6 as sql, aw as PgDialect, K as extractTablesRelationalConfig, U as createTableRelationsHelpers } from '../../relations-7adf6be2.mjs';
...
class AwsDataApiPreparedQuery extends PreparedQuery {
    ...
    async values(placeholderValues = {}) {
        ...
        return result.records?.map((result) => {
            return result.map((res) => getValueFromDataApi(res));
        });
    }
}
