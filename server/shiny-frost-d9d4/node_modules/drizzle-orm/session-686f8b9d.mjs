...
import { al as Table, ap as orderSelectedFields, Z as SQL, a4 as Param, a6 as sql, aq as mapUpdateSet, ad as SelectionProxyHandler, as as getTableColumns, av as View, $ as name, e as Column, an as getTableName, ab as Subquery, aa as SubqueryConfig, au as ViewBaseConfig, a5 as param, c as aliasedTableColumn, b as aliasedRelation, m as mapColumnsInAliasedSQLToAlias, G as Relation, S as normalizeRelation, i as and, h as eq, o as or, J as orderByOperators, d as mapColumnsInSQLToAlias, a as aliasedTable, I as operators, bH as TypedQueryBuilder, at as getTableLikeName, ac as WithSubquery, ar as applyMixins, Q as QueryPromise, V as mapRelationalRow } from './relations-7adf6be2.mjs';
...
/** @internal */
SQLiteTable.Symbol = Object.assign({}, Table.Symbol, {
...
class SQLiteRelationalQuery {
    ...
    prepare() {
        ...
        return this.session.prepareQuery(builtQuery, undefined, (rawRows, mapColumnValue) => {
            const rows = rawRows.map((row) => mapRelationalRow(this.schema, this.tableConfig, row, query.selection, true, mapColumnValue));
            if (this.mode === 'first') {
                return rows[0];
            }
            return rows;
...
//# sourceMappingURL=session-686f8b9d.mjs.map
